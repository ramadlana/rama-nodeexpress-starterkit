/*
 ...
 Source Server         : PostgreSQL Lab
 Source Server Type    : PostgreSQL
 Source Server Version : 140005
 Source Host           : 172.27.80.4:5432
...
INSERT INTO "public"."app_dummy_person" VALUES (301, 'user baru', 'alamat baru', 6);
...
-- ----------------------------
INSERT INTO "public"."app_users" VALUES (3, 'test', '$2b$10$r5LWuRoOh6gqGtL8t28Y4uoKaETNWufrDUxU0mxtMZeSff6htzMiu', 'test@test.com', 'user', 't');

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."county_id_seq"', 100, false);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."persons_id_seq"', 301, true);
